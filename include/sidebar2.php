...
<aside class="bg-[#F3F8FF] w-80 hidden md:block border border-gray-300 m-4 mr-0 rounded-lg overflow-hidden">
  ...
  <div class="flex relative mr-4">
    <a href="document.php" class="ml-8 flex p-1 w-full rounded-xl text-[#004369] my-1">
      <span class="flex items-center gap-2">
...
<?php endif; ?>
  ...
  <?php if ($role === 'admin' || $role === 'staff'): ?>
  <div class="flex relative mr-4">
    <a href="all_documents.php" class="ml-8 flex p-1 w-full rounded-xl text-[#004369] my-1">
      <span class="flex items-center gap-2">
...
<?php endif; ?>
  ...
  <?php if ($role === 'admin' || $role === 'staff' || $role === 'employee'): ?>
    <div class="flex relative mr-4">
      <a href="announcement.php" class="ml-8 flex p-1 w-full rounded-xl text-[#004369] my-1">
        <span class="flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
               viewBox="0 0 24 24" fill="none" stroke="currentColor"
               stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
