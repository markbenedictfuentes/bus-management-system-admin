...
<body>
    <div class="flex h-screen">
        <aside class="bg-[#F3F8FF] w-80 hidden md:block border border-gray-300 m-4 mr-0 rounded-lg overflow-hidden">
            ...
            <div class="flex flex-col mr-4">
                <a href="visitor.php" class='flex relative my-1 w-full'>
            ...
            <nav
                ...
                <div class="flex w-full">
                    ...
                    <div class="relative flex justify-between w-full">
                        <div class="mx-4 my-4 font-medium text-3xl text-[#004369]">Visitor Management</div>
    ...
    <?php while ($row = $result->fetch_assoc()): ?>
        <tr>
            ...
            <td>
                <a href="#" onclick="editUser(<?php echo $row['id']; ?>, '<?php echo $row['name']; ?>', '<?php echo $row['email']; ?>', '<?php echo $row['role']; ?>')">Edit</a>
