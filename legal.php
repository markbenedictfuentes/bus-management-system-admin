    ...
    <div class="flex h-screen">
        <aside class="bg-[#F3F8FF] w-80 hidden md:block border border-gray-300 m-4 mr-0 rounded-lg overflow-hidden">
            ...
            <div class='flex relative'>
                <a href="dashboard.php" class='ml-8 flex p-1 w-full rounded-xl text-[#004369] mr-4'>
            ...
            <div class="flex flex-col mr-4">
                <a href="legal.php" class='flex relative my-1 w-full'>
            ...
            <nav
                ...
                <div class="flex w-full">
                    ...
                    <div class="relative flex justify-between w-full">
                        <div class="mx-4 my-4 font-medium text-3xl text-[#004369]">Legal Management</div>
                ...
                <div class="max-w-4xl mx-auto py-10">
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <h2 class="text-2xl font-semibold mb-4">Legal Management</h2>
            

                        <div class="bg-gray-50 p-4 rounded-md mb-6">
                            <h3 class="text-xl font-semibold mb-4">Add New Legal Document</h3>
                            <form id="legalForm" class="space-y-4">
                                <div>
                                ...
                                <div>
                                    <button type="submit" class="w-full bg-[#004369] text-white p-2 rounded-lg">
                                       <p class="text-center">Add Document</p>
                                    </button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="bg-white p-4 rounded-md">
                            <h3 class="text-xl font-semibold mb-4">Legal Document Tracking</h3>
                        ...
                        <div class="mt-10 bg-yellow-100 p-4 rounded-md">
                            <h3 class="text-xl font-semibold mb-4">Legal Notices & Compliance Issues</h3>
                            <ul id="legalNotices" class="list-disc pl-6 text-yellow-700">
                            </ul>
                        </div>
                    </div>
                </div>
            
                <script src="js/legalmanage.js">
                </script>
